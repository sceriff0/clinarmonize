...
workflow CLINARMONIZE_CLINICALHARMONIZE {
    ...
    CLINICALHARMONIZE (
        ...
        params.blocking_rules,
        params.max_block_size,
        params.max_pairs_warn_frac,
        params.link_em_iterations,
        params.link_comparison_spec,
        params.link_u_from_random_pairs,
        params.link_random_pair_n,
        params.match_threshold,
        params.clerical_threshold,
        params.max_collapse_ratio_drop,
